 ...
 *  @ingroup gse_head_access
 */
bool gse_is_llc(const uint16_t protocol_type) __attribute__((warn_unused_result));
 ...
 *  @ingroup gse_head_access
 */
bool gse_is_ext_hdr(const uint16_t protocol_type) __attribute__((warn_unused_result));
