...
static const char* const gse_status_string[GSE_STATUS_MAX] = {
    ...
    [0x0509] = "Cannot add extension because this is a fragment or there are already extensions in "
               "the GSE packet",
    ...
    [0x0901] = "A complete PDU is returned",
    [0x0902 ... 0x09FF] = "Unknown status",
    ...
    [0x0B01] = "The CRC has been updated but this was not the last fragment, update the next "
               "packet in the fifo",
